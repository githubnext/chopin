...
test("renders native table elements with authoritative slots and forwarded semantic attributes", () => {
	...
	expect(markup).toContain('<thead class="cv-table-header custom-header" data-slot="table-header"');
	expect(markup).toContain('<tbody class="cv-table-body custom-body" data-slot="table-body"');
	expect(markup).toContain('<tfoot class="cv-table-footer custom-footer" data-slot="table-footer"');
