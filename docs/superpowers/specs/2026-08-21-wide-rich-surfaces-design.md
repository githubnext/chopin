...
an intrinsically wider diagram continues to scroll inside its preview.
...
for internal scrolling, page containment, and table-rail alignment. Add a contained nested fixture
so the direct-child boundary is covered.
